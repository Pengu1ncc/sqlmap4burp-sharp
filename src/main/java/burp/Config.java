...
public class Config {
    ...
    public static String[] TERMINAL_LISR = new String[]{"Terminal", "iTerm2"};
    private static String TERMINAL_OPTION = TERMINAL_LISR[0];
    ...
    public static String getTerminalOption() {
        try {
            String val = BurpExtender.callbacks.loadExtensionSetting("TERMINAL_OPTION");
            if(val.equals("Terminal")){
                return Config.TERMINAL_OPTION;
            }else{
                return val;
            }
        }catch(Exception e){
    ...
    public static void setTerminalOption(String terminalOption) {
        BurpExtender.callbacks.saveExtensionSetting("TERMINAL_OPTION", String.valueOf(terminalOption));
        Config.TERMINAL_OPTION = terminalOption;
    }
